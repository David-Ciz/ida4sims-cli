...
from py4lexis.models.directory_tree import (
    TreeDirectoryObject, 
    TreeFileObject
)
...
class DirectoryTree(object):
    """
        ...
        where content is the JSON content of the HTTP request for list of files, i.e. content inside of function py4lexis.ddi.get_content_of_dataset().        
    ...
    def to_dataframe_row(self) -> list[str | int] | None:
        ...
        while parent is not None and parent.parent is not None:
            parts.append(parent.tree_item.name)
            parent = parent.parent
        ...
        if self.tree_item.is_dir():
            if parent is not None:
                return [self.tree_item.name, path, "directory", None, None, None]
            else:
                return [self.tree_item.name, path, "root", None, None, None]
        else:
            return [self.tree_item.name, path, "file", self.tree_item.size, self.tree_item.create_time, self.tree_item.checksum]